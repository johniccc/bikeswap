<div class="page-header">
  ...
  <div class="page-header-actions">
    ...
    <a href="/bike/<?= e($bike->getQrHash()) ?>" class="btn btn-ghost btn-sm" target="_blank">
      <i data-lucide="external-link"></i> Veřejný detail
    </a>
  </div>
</div>
...
<div class="card mb-lg">
  ...
  <div class="card-body">
    ...
    <div class="info-row">
      ...
      <span class="info-value">
        <?php $statusLabels = ['active' => 'Aktivní', 'stolen' => 'Odcizené', 'found' => 'Nalezeno', 'recovered' => 'Vráceno']; ?>
